import { Graph, RT, PROFILES, makeProfile } from './router.js?v=57ba263b';
import { LANGS, makeT, floorName } from './i18n.js?v=57ba263b';
import { verticalSVG } from './icons.js?v=57ba263b';
