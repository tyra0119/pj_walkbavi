import { Graph, RT, PROFILES, makeProfile } from './router.js?v=f82ef03c';
import { LANGS, makeT, floorName } from './i18n.js?v=f82ef03c';
import { verticalSVG } from './icons.js?v=f82ef03c';
